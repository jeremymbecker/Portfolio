                    ...
                    <div id="projects">
                        ...
                        <div id="project-6" className="project project-background-color project-box-shadow">
                            ...
                            <div className="project-name-container">
                                ...
                                <div className="project-text-container project-text-container-light project-text-color-light project-box-shadow">
                                    <p>This project was developed primarily using the ReactJS library, serving as a captivating showcase of the integration of various APIs such as the Web Audio API, Material UI, and jsmediatags API. It empowers music enthusiasts to immerse themselves in a dynamic audio experience, where the music's frequencies are transformed into bytes, elegantly visualized as a continuous array of 128 bars with their heights dynamically shifting to the rhythm of the song. The user interface is both intuitive and interactive, allowing users to effortlessly upload, play, pause, adjust playback positions, and control the volume of their chosen tracks. Additionally, the playlist management offers options to replay, skip, or shuffle songs. Lastly, newly added features in the last update include the viewing of the song's title, artist, and album cover and a streamlined menu to upload and select songs as well as a customization tool to alter the background for a better user experience. Stay tuned for more added features such as personalized backgrounds and custom visualizer colors. In the meantime, take your time to explore and enjoy our audio visualizer and music player.</p>
                                </div>
                                <div className="programming-language-framework-project-container">
                                    <div className="programming-language-framework-text-container programming-language-framework-text-container-light">
                                        <p className="programming-language-framework-text featured-project-light">HTML</p>
